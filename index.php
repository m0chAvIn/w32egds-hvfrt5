...
$basePath .= "://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['REQUEST_URI']);
...
$validKeys = array_filter(explode(' ', file_get_contents($paramFile))); // Filter untuk menghapus array kosong
...
function getUrl($keyword, $key) {
    global $basePath;
    $url = $basePath . "/?{$key}=" . urlencode($keyword);
...
$brand = $_GET[$key];
$signUp = 'https://kutt.arrehlah.com/pompit';
$banner = 'https://i.postimg.cc/bJtfyCqx/pg-slot-6.png';
$favicon = 'https://tkb929th.com/tkb929.webp';
$logo = 'https://i.ibb.co/hW17GL4/image.png';
$brandUp = strtoupper($brand);

$contents = file_get_contents(__DIR__ . '/thaikeyword.txt');
$keywords = array_filter(explode("\r\n", $contents)); // Hapus baris kosong

$title = "{$brand} เว็บตรง PG Slot แตกง่าย โบนัสออกบ่อย เล่นสนุก";
$description = "เล่นสล็อตกับ {$brand} เว็บตรง PG Slot แตกง่าย เล่นสนุก โบนัสออกบ่อย ระบบเสถียร ฝาก-ถอนออโต้ เว็บพนันออนไลน์ รวดเร็ว ปลอดภัย รองรับทุกอุปกรณ์!";
$article = "<p>หากคุณเป็นคนที่ชื่นชอบการเล่นสล็อตและต้องการเว็บที่มั่นคง ปลอดภัย {$brand} คือตัวเลือกที่ตอบโจทย์ที่สุด เว็บตรงไม่ผ่านเอเย่นต์ รวมเกมสล็อตจาก PG Slot ค่ายเกมยอดนิยมที่ขึ้นชื่อเรื่องโบนัสแตกง่ายและมีอัตราการจ่ายสูง</p>
<p>ที่ {$brand} คุณจะได้สัมผัสประสบการณ์การเล่นที่ลื่นไหล ด้วยระบบที่ทันสมัย รองรับทุกอุปกรณ์ ไม่ว่าจะเป็นมือถือหรือคอมพิวเตอร์ อีกทั้งยังมีระบบ ฝาก-ถอนออโต้ ที่รวดเร็ว ช่วยให้การทำธุรกรรมเป็นเรื่องง่ายและปลอดภัย</p>
<p>เพลิดเพลินกับเกมสล็อตคุณภาพ พร้อมฟีเจอร์พิเศษที่ช่วยเพิ่มโอกาสทำกำไร สมัครเลยวันนี้กับ {$brand} แล้วมาลุ้นแจ็คพอตแตกง่ายไปด้วยกัน!</p>";
...
if ($brand == 'sitemap.xml') {
  ...
  $totalParams = count($validKeys);
  $totalKeywords = count($keywords);

  if ($totalParams == 0 || $totalKeywords == 0) {
      http_response_code(500);
      die("Error: param.txt atau thaikeyword.txt kosong.");
  }

  $usedParams = [];
  $paramIndex = 0; // Mulai dari parameter pertama

  foreach ($keywords as $keyword) {
      $paramKey = $validKeys[$paramIndex]; // Ambil parameter dari daftar

      if (!isset($usedParams[$paramKey])) {
          $usedParams[$paramKey] = true;
      }

      $urlElement = $xml->addChild('url');
      $urlElement->addChild('loc', htmlspecialchars($basePath . "/?{$paramKey}=" . urlencode($keyword)));
      $urlElement->addChild('lastmod', date('Y-m-d'));
      $urlElement->addChild('changefreq', 'daily');
      $urlElement->addChild('priority', '0.8');

      $paramIndex = ($paramIndex + 1) % $totalParams; // Gunakan parameter berikutnya (round-robin)
  }
...
<head>
  ...
  <meta name="keywords" content="<?=$brand;?>,<?=$brand;?> login" />
  ...
  <link rel="shortcut icon" href="https://tkb929th.com/tkb929.webp" />
...
<style>
  ...
  #container, body,.breadcrumb_list, #pdp-nav, .lzd-menu-labels, .lzd-header-content, .lzd-site-menu-nav-container, .lzd-header .mui-zebra-module .lzd-site-nav-menu-active{
    background: #e7e7e7;
    background-color: #e7e7e7;
  }
.lzd-header .lzd-nav-search{
font-weight: bold;
 background: linear-gradient(45deg, #ff33cc, #9933ff, #00ccff, #33cc33, #ffff00, #ff9900, #ff0000);
...
@keyframes gradientAnimation {
 ...
 100% {
  ...
  .pdp-block__main-information, .seller-container, .seller-name, #root.pdp-block{
    background: #e7e7e7;
    background-color: #e7e7e7;
  }
            ...
            <div class="links-list header-content ID id">
                <div class="top-links-item" id="topActionInternalFeedback" style="display:none;">
                  ...
                  <div class="top-links-item" id="topActionFeedback">
                      <a class="highlight" target="_blank" href="<?=$baseUrl;?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">รับโบนัสได้ที่ <?=$brandUp;?></a>
                  </div>
      ...
      <ul class="account-list">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><img src="https://i.ibb.co/hW17GL4/image.png" alt="PG Slot"></div>
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/i/id/LandingPage/lazmall?wh_weex=true&amp;wx_navbar_transparent=true&amp;data_prefetch=true&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207795_7692459">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                    <img alt="<?=$title;?>" class="lzd-site-nav-menu-iconfont-img" src="https://i.ibb.co/rp8c98W/pg-slot-3.png">
                </span>
            ...
            <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/i/id/digitalgoods/home?hybrid=1&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207798_7692459">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                    <img alt="Pulsa &amp;" class="lzd-site-nav-menu-iconfont-img" src="https://i.ibb.co/rp8c98W/pg-slot-3.png">
                </span>
            ...
            <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/gcp/route/lazada/id/upr_1000345_lazada/channel/id/upr-router/id_upr?hybrid=1&amp;data_prefetch=true&amp;at_iframe=1&amp;wh_pid=/lazada/channel/id/all-promo/mcp-ush&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207802_7692459&amp;prefetch_replace=1">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                    <img alt="Voucher &amp;" class="lzd-site-nav-menu-iconfont-img" src="https://i.ibb.co/rp8c98W/pg-slot-3.png">
                </span>
            ...
            <a class="lzd-menu-labels-item" href="https://www.lazada.co.id/blog/?scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207806_7692459">
                <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                    <img alt="LazBlog" class="lzd-site-nav-menu-iconfont-img" src="https://i.ibb.co/rp8c98W/pg-slot-3.png">
                </span>
                <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                <span class="lzd-menu-labels-item-text">สล็อตทดลอง</span>
            </a>
        </nav>
    </div>
</div>
